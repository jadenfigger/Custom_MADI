...
Usage:
    ...
    python analyze_library.py --library madi_dense.npz --output analysis_dense/

    python analysis/analyze_library.py --library data/libraries/madi_dense_human.npz --output analysis_dense_human/
    python analysis/analyze_library.py --library data/libraries/madi_dense.npz --output analysis_dense/
